              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    >
                     <thead>
                      ...
                      <tbody>
                         <?php $no=1; ?>
                  <?php foreach($dt_dokumen_pts as $d): ?>
                        <tr>
                          <td><?= $no++; ?></td>
                  ...
                  onclick="return confirm('anda yakin ingin menghapus data ini')"
                   href="<?php echo base_url('admin/delete_dokumen_pts/'.$d->id_dokumen_pts.'/'.$d->kode_pt);?>" 
...
<div
    ...
    echo form_open_multipart('admin/simpan_dokumen_pts'); ?>
                   ...
                   <div class="mb-3">
                      ...
                      <input type="hidden" class="form-control"  name="kode_pt" value="<?= $id; ?>" required >
                            </div>
